        ...
        <TabsContent value="variants">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Different radio group layouts and configurations
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Standard vertical layout with labels
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Horizontal arrangement for compact layouts
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Radio items with descriptive text below labels
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Disabled radio group with muted appearance
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Radio item with invalid state styling
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="guidelines">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Best practices for using radio group components
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Form inputs requiring one choice from multiple options
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Maintain consistent spacing between radio items and labels
                  </li>
                  <li>
                    Ensure sufficient contrast for selected and unselected
                    states
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    Always associate labels with radio items using{" "}
                    <code className="bg-background px-1 py-0.5 rounded text-xs">
                      htmlFor
                    </code>{" "}
                    and{" "}
                  ...
                  <li>
                    Ensure keyboard navigation works properly (arrow keys, Tab,
                    Space)
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Consider the layout (vertical vs horizontal) based on
                    content length
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Vertical Layout:</strong> Best for longer labels,
                    descriptions, or when space allows
                  </li>
                  <li>
                    <strong>Horizontal Layout:</strong> Good for short labels
                    and compact interfaces
                  </li>
                  <li>
                    Use consistent spacing between items (typically{" "}
                    <code className="bg-background px-1 py-0.5 rounded text-xs">
                      space-x-2
                    </code>{" "}
                    or{" "}
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Use appropriate disabled states when options are unavailable
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Labels:</strong> Keep them concise but descriptive
                  </li>
                  <li>
                    <strong>Descriptions:</strong> Add explanatory text for
                    complex options
                  </li>
                  <li>
                    <strong>Icons:</strong> Use visual cues when helpful (flags,
                    sizes, etc.)
                  </li>
                  <li>
                    <strong>Grouping:</strong> Organize related options with
                    visual separators
                  </li>
                  <li>
                    <strong>Ordering:</strong> Place most common or recommended
                    options first
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    Keep radio groups lightweight and avoid complex nested
                    structures
                  </li>
                  <li>
                    Use appropriate state management patterns to avoid
                    unnecessary re-renders
                  </li>
                  <li>
                    Consider virtualization for extremely long option lists (50+
                    items)
                  </li>
