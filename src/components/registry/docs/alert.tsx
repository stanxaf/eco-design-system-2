        ...
        <TabsContent value="variants">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Different alert styles for different message types
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Critical errors and dangerous situations
                </p>
              </div>
              ...
              <div>
                ...
                >
                  <Info className="size-4" />
                  <AlertTitle>
                    Important Information with Very Long Title That Should Not
                    Overlap
                  </AlertTitle>
                  <AlertDescription>
                    This is a very long informational message that demonstrates
                    how the close button is positioned in the top right corner
                    without overlapping with the text content, even when the
                    title and description are quite lengthy.
                  </AlertDescription>
                </Alert>
                <p className="text-sm text-muted-foreground mt-2">
                  Close button positioning with long content
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Default:</strong> General information, announcements
                  </li>
                  <li>
                    <strong>Destructive:</strong> Critical errors, dangerous
                    actions, session issues
                  </li>
                  <li>
                    <strong>Info:</strong> Important updates, system
                    information, helpful tips
                  </li>
                  <li>
                    <strong>Success:</strong> Successful operations,
                    confirmations, completion notices
                  </li>
                  <li>
                    <strong>Warning:</strong> Cautionary messages, validation
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Consider screen reader announcements for critical alerts
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    Use consistent iconography across similar message types
                  </li>
                  <li>
                    Position alerts prominently but don't overwhelm the
                    interface
                  </li>
                  <li>Provide clear next steps or actions when appropriate</li>
                  <li>
                    Use alerts sparingly - not every message needs to be an
                    alert
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Title:</strong> Brief, action-oriented summary (5-10
                    words)
                  </li>
                  <li>
                    <strong>Description:</strong> Clear explanation with context
                    and next steps
                  </li>
                  <li>
                    <strong>Icons:</strong> Use consistent icons that match the
                    message type
                  </li>
                  <li>
                    <strong>Tone:</strong> Match the alert variant to the
                    message urgency
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    Place alerts at the top of content areas for visibility
                  </li>
                  <li>
                    Use consistent spacing and alignment across all variants
                  </li>
                  <li>
                    Ensure alerts don't interfere with primary content flow
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Use sparingly:</strong> Only for non-critical,
                    dismissible messages
                  </li>
                  <li>
                    <strong>Positioning:</strong> Always in top-right corner,
                    never overlaps text
                  </li>
                  <li>
                    <strong>Accessibility:</strong> Includes proper aria-label
                    and screen reader support
                  </li>
                  <li>
                    <strong>State management:</strong> Handle close events in
                    your application logic
                  </li>
                  <li>
                    <strong>Visual feedback:</strong> Hover and focus states for
                    better UX
                  </li>
                  <li>
                    <strong>Critical alerts:</strong> Never make error or
                    destructive alerts dismissible
                  </li>
                </ul>
              </div>
            </CardContent>
