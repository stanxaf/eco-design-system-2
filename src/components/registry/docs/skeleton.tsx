        ...
        <TabsContent value="variants">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Different skeleton shapes and sizes for loading states</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div>
                <h4 className="text-sm text-muted-foreground p-3 bg-muted rounded-md">
                  <strong>Note:</strong> The skeleton component uses <code className="bg-background px-1 py-0.5 rounded text-xs">bg-muted</code> for a subtle, muted appearance that doesn't compete with actual content.
                </h4>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">User profile layout</p>
                </div>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <p className="text-xs text-muted-foreground">Card with content</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">Table data rows</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="guidelines">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Best practices for using skeleton loading states</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>Data fetching operations (API calls, database queries)</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>Use <code className="bg-background px-1 py-0.5 rounded text-xs">bg-muted</code> for subtle, non-intrusive appearance</li>
                  <li>Match skeleton dimensions to actual content size</li>
                  <li>Maintain consistent spacing and layout with real content</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>Use <code className="bg-background px-1 py-0.5 rounded text-xs">aria-busy="true"</code> on loading containers</li>
                  <li>Ensure skeleton content doesn't interfere with navigation</li>
                  <li>Provide fallback content for users who disable animations</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>Use appropriate skeleton shapes for different content types</li>
                  <li>Provide loading progress indicators for long operations</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li><strong>Text:</strong> Use rectangular shapes with appropriate heights</li>
                  <li><strong>Images:</strong> Match aspect ratios and use rounded corners</li>
                  <li><strong>Avatars:</strong> Use circular shapes with consistent sizing</li>
                  <li><strong>Cards:</strong> Maintain padding and border radius</li>
                  <li><strong>Forms:</strong> Preserve input heights and spacing</li>
                  <li><strong>Tables:</strong> Keep column widths consistent</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>Keep skeleton animations lightweight (CSS-only when possible)</li>
                  <li>Use <code className="bg-background px-1 py-0.5 rounded text-xs">animate-pulse</code> for subtle movement</li>
                  <li>Avoid complex animations that might cause layout shifts</li>
                  <li>Consider reducing motion for users with vestibular disorders</li>
